...
def computeRef(modeller, modelFile, variantsDict, targetPKa, params,
...
def runConstantPhSimulation(params):
    ...
    if 'ASP' in params['residuesToTitrate']:
        ...
        refenergies['ASP'] = computeRef(modeller,
            params['aspModel'],
            {1: ['ASP', 'ASH']},
            3.9,
            params,
    ...
    if 'GLU' in params['residuesToTitrate']:
        ...
        refenergies['GLU'] = computeRef(modeller,
            params['gluModel'],
            {1: ['GLU', 'GLH']},
            4.2,
            params,
    ...
    if 'CYS' in params['residuesToTitrate']:
        ...
        refenergies['CYS'] = computeRef(modeller,
            params['cysModel'],
            {1: ['CYS', 'CYX']},
            7.1,
            params,
    ...
    if 'LYS' in params['residuesToTitrate']:
        ...
        refenergies['LYS'] = computeRef(modeller,
            params['lysModel'],
            {1: ['LYS', 'LYN']},
            10.5,
            params,
    ...
    #todo do i cut here to build the system?

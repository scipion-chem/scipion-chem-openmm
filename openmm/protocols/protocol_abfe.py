...
class ProtOpenFEABFE(ProtOpenFEBase):
    """
    ...
    def parseLigandNames(self):
        ...
        return self.parseSetupFile(self.getLigandNamesFile(), 2)
    ...
    def _summary(self):
        return self.summaryWithReports(('dg', 'raw'), 'openfe gather-abfe')

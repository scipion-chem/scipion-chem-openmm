...
class ProtOpenMMSystemPrepConstantPH(EMProtocol):
    """
    This protocol will start a Molecular Dynamics system preparation with constant pH specified by user.
    """
    _label = 'constant pH system preparation'
    ...
    def _defineParams(self, form):
        ...
        form.addParam('inputStructure', params.PointerParam, label="Input structure: ", allowsNull=False,
                      important=True, pointerClass='AtomStruct', help='Atomic structure to be prepared for MD by solvation, ions addition etc.')
        ...
        titrGroup.addParam('relaxSteps', params.IntParam, default=500, label="Relaxation steps for titration: ",
                          expertLevel=params.LEVEL_ADVANCED,
                          help='Number of steps for initial relaxation of the system')
        titrGroup.addParam('equilSteps', params.IntParam, default=100, label="Equilibration steps for titration: ",
                          expertLevel=params.LEVEL_ADVANCED,
                          help='Number of equilibration cycles')
        titrGroup.addParam('stepEquil', params.IntParam, default=1, label="Steps per equilibration cycle titration: ",
                          expertLevel=params.LEVEL_ADVANCED,
        ...
        fform.addParam('nonbondedMethodExp', params.EnumParam, default=0,
        ...
        fform.addParam('nonbondedMethodImp', params.EnumParam, default=0,
                       choices=['NoCutoff', 'CutoffNonPeriodic', 'CutoffPeriodic', 'Ewald', 'PME', 'LJPME'],
        ...
        iGroup = form.addGroup('Integrators')
    ...
    def productionRunStep(self):
        paramsFile = self.getParamsFile()
        Plugin.runScript(self, 'openmmConstantpHPrep.py', args=f' --params {paramsFile}', env=OPENMM_DIC, cwd=self._getPath())
